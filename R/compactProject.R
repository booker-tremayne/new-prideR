...
#' compactProjectSummaryList represents a PRIDE Archive project collection
#'
#' @importFrom rjson fromJSON
#' @export
#' @exportClass compactProjectSummaryList
setClass(
  "compactProjectSummaryList",
  representation(
    query = "character",
    project.list = "list",
    page.number = "numeric",
...
setMethod("show",
          signature = "compactProjectSummaryList",
...
#' Returns the query term used to retrieve the compactProjectSummaryList
#'
#' @param object a compactProjectSummaryList instance
#' @return the query term used to retrieve this compactProjectSummaryList
#' @author Jose A. Dianes
#' @export
setMethod("query", "compactProjectSummaryList", function(object) object@query)
...
#' @author Jose A. Dianes
#' @export
setMethod("project.list", "compactProjectSummaryList", function(object) object@project.list)
...
#' @author Jose A. Dianes
#' @export
setMethod("page.number", "compactProjectSummaryList", function(object) object@page.number)
...
#' @author Jose A. Dianes
#' @export
setMethod("page.size", "compactProjectSummaryList", function(object) object@page.size)
